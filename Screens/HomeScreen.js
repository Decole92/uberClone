import { SafeAreaView, Platform, ScrollView, StyleSheet, Text, Image, View } from 'react-native'
...
<Slider />
 ...
 <Text style={tw("text-lg px-5 text-black text-lg pt-4 pb-1")}>Around you</Text>

 <View style={[tw("mx-4 my-4 rounded-lg"), {height:200, borderRadius:20}]}>
