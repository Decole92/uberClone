...
style={[tw("bg-white absolute left-5 rounded-full items-center justify-center"), {width:50,zIndex:100, top:20, height:50}]}>
...
<View style={tw("h-1/2")}>
  ...
  <Text style={tw("text-center text-sm py-2 ")}>Choose a ride - Distance ({distance.toFixed(1)} Km)</Text>
...
<RideOptions  distance={distance} duration={duration} />
  ...
  <TouchableOpacity 
  disabled={!selected}
  style={[ !selected ? tw("bg-gray-200 items-center absolute bottom-4 w-full justify-center mx-5") : tw("bg-black items-center absolute bottom-4 w-full justify-center mx-5"), {width:350, height:50}]}>
