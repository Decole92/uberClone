...
const ActivityScreen = () => {
  ...
  const [origin, setOrigin] = useState({ latitude: 50.081, longitude: 14.428 });
  const [destination, setDestination] = useState({
    latitude: 50.0694024772,
    longitude: 14.3015465873,
  });
  ...
  return (
    <View style={tw("flex-1 bg-white h-full w-full")}>
      <ScrollView>
        <Text style={tw("text-3xl font-semibold py-4 px-5 text-black")}>
          Activity
        </Text>
        ...
        <TouchableOpacity
          style={[
            tw(
              "flex-row mx-4 border-2 rounded-xl border-gray-200 justify-between  px-4 pt-2"
            ),
            { height: 80 },
          ]}
        >
          <View>
            ...
            <Text
              style={tw(
                "text-black text-sm font-semibold pt-1 items-center justify-center"
              )}
            >
              Reserve your ride{" "}
        ...
        <TouchableOpacity
          style={[
            tw("border-2 border-gray-200 rounded-xl mx-4"),
            { height: 330 },
          ]}
        >
          ...
          <Text style={tw("px-3 text-lg font-semibold")}>
            {" "}
            Na moklině 289/16, Řepy{" "}
          </Text>
          <Text style={tw("px-4 text-gray-400 ")}>
            Aug 20 <Entypo name="dot-single" size={10} /> 5:53 PM
          </Text>
        ...
        <FlatList
          ...
          renderItem={({ item: { address, date, time, price } }) => (
            <TouchableOpacity
              style={tw("flex-row justify-between items-center my-7 mx-5")}
            >
              <View style={tw("bg-gray-100 items-center rounded-xl")}>
                <Ionicons
                  name="time"
                  style={{ top: 10, position: "absolute", right: 25 }}
                  size={15}
                />
                <Image
                  resizeMode="contain"
